        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-sm text-muted-foreground mt-2">
                {Math.round((fundedAmount / totalAmount) * 100)}% of total value
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-3xl">{recentOffers.length}</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="lg:col-span-2">
            <Card>
              <CardHeader className="flex flex-row items-center justify-between">
                ...
                <Button onClick={() => router.push("/upload-invoice")}>
                  Upload Invoice
                </Button>
              </CardHeader>
              <CardContent>
                    ...
                    recentOffers.map((offer) => (
                      <div key={offer.id} className="p-4 border rounded-lg">
                        ...
                        <p className="text-sm text-gray-600 mb-2">
                          {formatCurrency(offer.amountRequested)} funding offer
                        </p>
